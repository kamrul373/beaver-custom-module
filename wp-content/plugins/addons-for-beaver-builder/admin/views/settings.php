                ...
                <div class="labb-tab-content custom-css">
                    ...
                    <div class="labb-inner labb-box-inner">
                        <div class="labb-row labb-field labb-custom-css">
                            ...
                            <textarea class="labb-textarea" name="labb_custom_css" id="labb_custom_css" rows="20" cols="120"><?php echo wp_kses_post( $custom_css) ?></textarea>
                ...
                <div class="labb-tab-content premium-version">
                    ...
                    <div class="labb-inner labb-box-inner">
                        ...
                        <div class="labb-row labb-field labb_premium_version">
                            ...
                            <ul>
                                <li><a href="https://livemeshwp.com/beaver-builder/posts-block/" title="Post Blocks Addon" target="_blank">Post
                                ...
                                <li><a href="https://livemeshwp.com/beaver-builder/tabs/" title="Tabs Addon" target="_blank">Responsive
                                ...
                                <li><a href="https://livemeshwp.com/beaver-builder/accordion/" title="Accordion/Toggle Addon" target="_blank">Accordion/Toggle</a> - Controls
                                    that capture collapsible content panels when space is limited.
                                </li>
                                <li><a href="https://livemeshwp.com/beaver-builder/sliders/" title="Image Slider Widget" target="_blank">Image
                                ...
                                <li><a href="https://livemeshwp.com/beaver-builder/image-gallery/" title="Image Gallery Widget" target="_blank">Image
                                        Gallery</a> - Create a gallery of images with options for masonry
                                    or fit rows, pagination, lazy load, lightbox support etc.
                                </li>
                                <li><a href="https://livemeshwp.com/beaver-builder/video-gallery/" title="Video Gallery Widget" target="_blank">Video
                                        Gallery</a> - Create a beautiful gallery of videos to help
                                    showcase a collection of YouTube/Vimeo videos on your site.
                                </li>
                                <li><a href="https://livemeshwp.com/beaver-builder/gallery-carousel/" title="Image Carousel" target="_blank">Image
                                        Carousel</a> - Build a responsive carousel of images.</li>
                                <li><a href="https://livemeshwp.com/beaver-builder/gallery-carousel/" title="Video Carousel" target="_blank">Video
                                        Carousel</a> - Build a responsive carousel of YouTube/Vimeo
                                    videos.
                                </li>
                                <li><a href="https://livemeshwp.com/beaver-builder/buttons/" title="Buttons Addon" target="_blank">Buttons</a> - Animated buttons with great choice of colors.
                                </li>
                                <li><a href="https://livemeshwp.com/beaver-builder/icon-lists/" title="Icon List" target="_blank">Icon List</a> - - Create a list of icons with description and link - for social media profiles,
                                    for showcasing services or features as well with icons or images.
                                </li>
                                <li><a href="https://livemeshwp.com/beaver-builder/faq-element/" title="FAQ Addon" target="_blank">FAQ</a> - Create a set of Frequently Asked Questions for display in a
                                    page.
                                </li>
                                <li><a href="https://livemeshwp.com/beaver-builder/features/" title="Features Addon" target="_blank">Features Addon</a> for showcasing product features or services provided by an agency/business.
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li><a href="https://livemeshwp.com/beaver-builder/portfolio-grid-pro/" title="Posts Grid" target="_blank">Lazy Load</a> - The portfolio/post grid and image gallery elements
                                    incorporate option to lazy load posts/images with the click of a Load More button.
                                </li>
                                <li><a href="https://livemeshwp.com/beaver-builder/portfolio-grid-pro/" title="Posts Grid" target="_blank">Pagination</a> - Create a grid of posts or custom post types with AJAX
                            ...
                            <?php else: ?>
                                ...
                                <a class="labb-button know-more" href="https://livemeshwp.com/beaver-builder/"><i class="dashicons dashicons-external"></i><?php echo __('Know More', 'livemesh-bb-addons'); ?></a>
